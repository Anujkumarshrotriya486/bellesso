...
GmCXt.changeImageUpload = function(cb) {
    var fileElement = mg$('#mgPlayerJSTest2_upload-image-input');

    if (!fileElement.length) {
        var fileElement = mg$('<input />');
        fileElement.attr('type', 'file');
        fileElement.attr('id', 'mgPlayerJSTest2_upload-image-input');
...
GmCXt.setOnAudioMode = function() {
	GmCXt.sendMsgToAudioFrame('mgPlayerJSTest2_action:set_audio_mode_on');
	GmCXt.sendMessageToApp('mgPlayerJSTest2_action:set_audio_mode_on');
};

GmCXt.setOffAudioMode = function() {
	GmCXt.sendMsgToAudioFrame('mgPlayerJSTest2_action:set_audio_mode_off');
	GmCXt.sendMessageToApp('mgPlayerJSTest2_action:set_audio_mode_off');
};
