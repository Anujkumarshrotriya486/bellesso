...
if (!guideMe.baseUrl) {
	guideMe.baseUrl = "//anujkumarshrotriya486.github.io/bellesso/player/";
}
...
function getScriptCB() {
	...
	function loadGuideMeClientFiles() {
		if (window.self === window.top) {
			a.src = GmCXt.conf.baseUrl + 'gm_client_1733389296293.js';
		} else {
			a.src = GmCXt.conf.baseUrl + 'gm_client_iframe_1733389296293.js';
		}
