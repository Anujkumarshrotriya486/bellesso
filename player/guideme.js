...
if (!guideMe.baseUrl) {
	guideMe.baseUrl = "//anujkumarshrotriya486.github.io/bellesso/";
}
...
function getScriptCB() {
	...
	function loadGuideMeClientFiles() {
		if (window.self === window.top) {
			a.src = GmCXt.conf.baseUrl + 'gm_client_1737617616395.js';
		} else {
			a.src = GmCXt.conf.baseUrl + 'gm_client_iframe_1737617616395.js';
		}
